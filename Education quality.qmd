...
In contrast, private high schools exhibit a second peak at +1. The deviation of the private-sector distribution is much narrower, largely concentrated between −1 and +1, while the public-sector distribution is slightly more spread out and extends further to the left.
...
Knowing the distribution and correlations of IPS and private and public Parisian high schools we can analyse the mention rates associated to the two types of establishments.
...
```
For private high schools, the distribution of mention rates is extremely concentrated at very high levels. Most private schools are between about 85% and 100%, with a very strong peak close to 95–100%.

For public high schools, the distribution is much more spread out. A large share of public schools are above 50%, with a first peak around 55–60%, and a second mass between about 80% and 90%. This bimodal-looking shape suggests strong heterogeneity among  public parisian establishments, with some schools performing much closer to private-school levels, while others have substantially lower mention rates.

Overall, this figure shows a very strong sectoral gap in mention rates. Private schools are concentrated at the top of the distribution, while public schools display both lower average mention rates and much greater dispersion.
...
For private high schools, the distribution of value added to mention rates is shifted to the right and tightly concentrated around positive values. The main peak is clearly above zero (around +5), indicating that many private schools generate more mentions than expected given their student composition. The distribution has a long right tail, with some schools reaching very high positive value added (above +20 and even one close to +40).

For public high schools, the distribution is centered closer to zero and is more symmetric, with a substantial mass of negative values. Many public schools have negative value added to mention rates (down to around −15), meaning they produce fewer mentions than expected given their IPS. While there are also public schools with positive value added, the right tail is less extreme than in the private sector and stops before +20.